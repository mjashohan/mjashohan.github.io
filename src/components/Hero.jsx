...
import { getNavHeight } from './Navigation.jsx';
...
export default function Hero() {
    ...
    const scrollTo = (id) => {
        ...
        if (el) {
            const top = el.getBoundingClientRect().top + window.scrollY - getNavHeight() - 16;
        ...
        >
            ...
            <motion.div custom={1} initial="hidden" animate="visible" variants={fadeIn}>
                <Typography
                    variant="h1"
                    sx={{
                        fontSize: { xs: '2rem', sm: '2.9rem', md: '3.6rem', lg: '4.5rem' },
                        lineHeight: 1.05,
                        mb: 1.5,
            ...
            <motion.div custom={2} initial="hidden" animate="visible" variants={fadeIn}>
                <Typography
                    ...
                    sx={{
                        ...
                        fontSize: { xs: '1.15rem', sm: '1.5rem', md: '1.9rem', lg: '2.2rem' },
                        mb: 3,
                        fontWeight: 600,
                        // Reserve enough vertical space for the typewriter to avoid layout jumps
                        // when the longest line wraps on narrow screens.
                        minHeight: { xs: '3em', sm: '1.4em' },
                    }}
                >
                    {typed}
            ...
            <motion.div custom={4} initial="hidden" animate="visible" variants={fadeIn}>
                <Stack
                    ...
                    spacing={2}
                    sx={{
                        // Full-width CTAs on phones, auto width from sm up.
